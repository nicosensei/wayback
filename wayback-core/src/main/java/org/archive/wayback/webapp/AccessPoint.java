...
//		}
    ...
    throws IOException, ServletException, WaybackException {
        ...
        while (true) {
            ...
            try {
                ...
                // Should we redirect, if a better request exists?
                if (shouldRedirect(wbRequest, closest, originalClosest)) {
    ...
    /**
     * This method triggers whether during replay we should call
     * {@link #throwRedirect(WaybackRequest, HttpServletResponse, CaptureSearchResults, String, String)}
     * instead of directly rendering the replay result.
